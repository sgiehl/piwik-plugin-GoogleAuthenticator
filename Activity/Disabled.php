 ...
 *
 */
namespace Piwik\Plugins\GoogleAuthenticator\Activity;

use Piwik\Piwik;
use Piwik\Plugins\ActivityLog\Activity\Activity;

class Disabled extends Activity
{
    protected $eventName = 'GoogleAuthenticator.Disabled';
    ...
    {
        return Piwik::translate('GoogleAuthenticator_ActivityDisabled');
    }
}